  ...
  <nav class="flex-1 overflow-y-auto px-4 py-6 text-gray-700">
    <ul class="space-y-4">
      ...
      <li>
        ...
        <li>
  <a href="untrialbalance.php" class="flex flex items-center gap-3 px-3 py-2 rounded-lg transition-all 
    <?php echo ($title == 'Unadjusted Trial Balance')
      ? 'bg-red-50 text-red-700 font-semibold'
      : 'text-gray-700 hover:bg-red-50 hover:text-red-700 font-medium'; ?>">
    <span>
      <!-- Unadjusted: Scale icon (preliminary/draft) -->
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<li>
  <a href="adtrialbalance.php" class="flex flex items-center gap-3 px-3 py-2 rounded-lg transition-all 
    <?php echo ($title == 'Adjusted Trial Balance')
      ? 'bg-red-50 text-red-700 font-semibold'
      : 'text-gray-700 hover:bg-red-50 hover:text-red-700 font-medium'; ?>">
    <span>
      <!-- Adjusted: Clipboard with checkmark (finalized/verified) -->
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
