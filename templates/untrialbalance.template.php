...
<body>
    ...
    <?php if (empty($trialBalance)): ?>
        <p class="empty-notice">No Unadjusted Trial Balance Records Found</p>
    <?php else: ?>
        <table class="trial-balance">
            <thead>
                <tr>
                    ...
                    <th class="text-right" style="width: 16.67%;">Debit</th>
                    <th class="text-right" style="width: 16.67%;">Credit</th>
                    <th class="text-right" style="width: 16.67%;">Balance</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr class="account-row">
                        ...
                        <td class="amount-cell"><?= $debit > 0 ? number_format($debit, 2) : '0.00' ?></td>
                        <td class="amount-cell"><?= $credit > 0 ? number_format($credit, 2) : '0.00' ?></td>
                        <td class="amount-cell"><?= number_format($balance, 2) ?></td>
                    </tr>
                <?php endforeach; ?>
                ...
                <tr class="total-row">
                    ...
                    <td class="amount-cell"><strong><?= number_format($totalBalance, 2) ?></strong></td>
                </tr>
                ...
                ?>
                    <tr class="warning-row">
                        <td colspan="3">
                            ⚠️ Unadjusted Trial Balance is OUT OF BALANCE
                        </td>
