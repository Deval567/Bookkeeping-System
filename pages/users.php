...
<main class="g-gray-100 px-6 py-2">
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr class="bg-red-700 text-white">
                    <th class="py-2 px-4 text-left text-sm font-medium">Username</th>
                    <th class="py-2 px-4 text-left text-sm font-medium">Password</th>
                    <th class="py-2 px-4 text-left text-sm font-medium">User Role</th>
    ...
    <?php if (empty($users)): ?>
        <tr>
            <td colspan="4" class="py-4 px-4 text-center text-gray-500 font-semibold">
                No users found.
            </td>
        </tr>
    <?php else: ?>
