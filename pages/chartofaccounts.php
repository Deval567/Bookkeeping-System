...
$chartofacc = new chartofacc($conn, null, null, null, null);

$page = isset($_GET['page']) ? (int)$_GET['page'] : 1;

$charts = $chartofacc->getPaginatedCharts($page);
$total_pages = $chartofacc->getTotalPages();
   ...
   <table class="min-w-full bg-white">
    <thead>
        <tr class="bg-red-700 text-white">
            <th class="py-2 px-4 text-left text-sm font-medium">Account Name</th>
            <th class="py-2 px-4 text-left text-sm font-medium">Account Type</th>
